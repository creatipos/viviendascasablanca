...
*/
//$ark_root  = "http://www.".$_SERVER['HTTP_HOST'];
...
define('HTTP_assets', $config['base_url'].'assets/public/');
define('baseurlname', $config['base_url']);
define('base_admin', $config['base_url'].'admin/');
define('multimedia', $config['base_url'].'uploads/imagenes/');
